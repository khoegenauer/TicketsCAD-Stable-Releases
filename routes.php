...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
	...
	<link rel="stylesheet" href="./js/leaflet/leaflet073.css" />
	<!--[if lte IE 8]>
...
?>
	...
	<script src="./js/leaflet/leaflet073.js"></script>
...
<?php
			...
			print "<BR /><BR /><SPAN STYLE='display: inline-block;'  class='normal_text'><H3>to:<BR /><SPAN style='width: 150px; height: 200px;'><I>{$addr}</I></DIV></H3></SPAN>\n";
?>
		</div>	 <!-- end of outer -->
<?php
