...
?>
		...
		var baseIcon = L.Icon.extend({options: {shadowUrl: './our_icons/shadow.png',
			iconSize: [20, 32],	shadowSize: [37, 34], iconAnchor: [10, 16],	shadowAnchor: [5, -5], popupAnchor: [6, -5]
			}
			});
		var baseFacIcon = L.Icon.extend({options: {iconSize: [28, 28], iconAnchor: [14, 14], popupAnchor: [6, -5]
			}
			});
		var baseSqIcon = L.Icon.extend({options: {iconSize: [20, 20], iconAnchor: [10, 10], popupAnchor: [6, -5]
		}
		});
