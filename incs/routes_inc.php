...
?>	
							...
							var marker = createdummyMarker(<?php print get_variable('def_lat');?>, <?php print get_variable('def_lng');?>, myinfoTabs,<?php print $unit_row['icon'];?>, 0, i, "<?php print $unit_row['unit_name'];?>", "Incident", 0, "");	// (point,sidebar,tabs, color, id)
							marker.addTo(map);
<?php 						} else { ?>
