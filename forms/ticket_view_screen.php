...
?>				
<SCRIPT>
						var unitmarker = createUnitMarker(<?php print $row_unit['lat'];?>, <?php print $row_unit['lng'];?>, "<?php print quote_smart($theTabs);?>", 0, 0, <?php print $unit_id;?>, '<?php print $index;?>', '<?php print $resp_cat;?>', 0, '<?php print $handle;?>');
...
?>
<SCRIPT>
						var unitmarker = createUnitMarker(<?php print $row_unit['lat'];?>, <?php print $row_unit['lng'];?>, "<?php print quote_smart($theTabs);?>", 4, 0, <?php print $unit_id;?>, '<?php print $index;?>', '<?php print $resp_cat;?>', 0, '<?php print $handle;?>');
						unitmarker.addTo(map);
						bounds.extend([<?php print $row_unit['lat'];?>, <?php print $row_unit['lng'];?>]);
						i++
</SCRIPT>						
...
print add_sidebar(FALSE, TRUE, TRUE, FALSE, $allow_filedelete, $id, 0, 0, 0)
?>
<A NAME="bottom" />
