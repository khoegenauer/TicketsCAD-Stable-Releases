...
<DIV id='outer' style='position: absolute; left: 0px; z-index: 1;'>
	...
	<DIV id='left_sidebar' style='position: fixed; top: 30px; left: 0px; height: 500px; font-size: 1.2em; z-index: 9999; background-color: #FFFFFF;'>
		<SPAN id='showlists' class='plain' style='position: absolute; top: 0px; left: 0px; width: 35px; display: none; cursor: pointer; padding: 2px; background-color: #FEFEFE; text-align: right;' 
...
init_map(1, <?php print get_variable('def_lat');?>, <?php print get_variable('def_lng');?>, "", 9, theLocale, useOSMAP, "br");
map.setView([<?php print get_variable('def_lat');?>, <?php print get_variable('def_lng');?>], 9);
