...
print add_sidebar(FALSE, TRUE, TRUE, TRUE, $allow_filedelete, 0, $id, 0, 0)
?>
...
init_map(3, <?php print $thelat;?>, <?php print $thelng;?>, "", 13, theLocale, useOSMAP, "tr");
map.setView([<?php print $thelat;?>, <?php print $thelng;?>], 13);
